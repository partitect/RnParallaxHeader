...
const DEFAULT_NAVBAR_COLOR = '#40ADFF';
const DEFAULT_BACKGROUND_COLOR = '#40ADFF';
...
class RNParallax extends Component {
  ...
  renderNavbarBackground() {
    ...
    const borderBottomLeftRadius = this.state.scrollY.interpolate({
      inputRange: [0, this.getHeaderMaxHeight()],
      outputRange: [47,0],
      extrapolate: "clamp"
    });
    const borderBottomRightRadius = this.state.scrollY.interpolate({
      inputRange: [0, this.getHeaderMaxHeight()],
      outputRange: [47,0],
      extrapolate: "extend"
    });
